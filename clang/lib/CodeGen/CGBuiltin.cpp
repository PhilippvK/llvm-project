...
case RISCV::BI__builtin_xcorevmac_mac_mac:
    ID = Intrinsic::riscv_xcorevmac_mac_mac;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_msu:
    ID = Intrinsic::riscv_xcorevmac_mac_msu;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulun:
    ID = Intrinsic::riscv_xcorevmac_mac_mulun;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulhhun:
    ID = Intrinsic::riscv_xcorevmac_mac_mulhhun;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulsn:
    ID = Intrinsic::riscv_xcorevmac_mac_mulsn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulhhsn:
    ID = Intrinsic::riscv_xcorevmac_mac_mulhhsn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulurn:
    ID = Intrinsic::riscv_xcorevmac_mac_mulurn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulhhurn:
    ID = Intrinsic::riscv_xcorevmac_mac_mulhhurn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulsrn:
    ID = Intrinsic::riscv_xcorevmac_mac_mulsrn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_mulhhsrn:
    ID = Intrinsic::riscv_xcorevmac_mac_mulhhsrn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_macun:
    ID = Intrinsic::riscv_xcorevmac_mac_macun;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_machhun:
    ID = Intrinsic::riscv_xcorevmac_mac_machhun;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_macsn:
    ID = Intrinsic::riscv_xcorevmac_mac_macsn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_machhsn:
    ID = Intrinsic::riscv_xcorevmac_mac_machhsn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_macurn:
    ID = Intrinsic::riscv_xcorevmac_mac_macurn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_machhurn:
    ID = Intrinsic::riscv_xcorevmac_mac_machhurn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_macsrn:
    ID = Intrinsic::riscv_xcorevmac_mac_macsrn;
    break;
  case RISCV::BI__builtin_xcorevmac_mac_machhsrn:
    ID = Intrinsic::riscv_xcorevmac_mac_machhsrn;
    break;
case RISCV::BI__builtin_xcorevalu_alu_abs:
    ID = Intrinsic::riscv_xcorevalu_alu_abs;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_exths:
    ID = Intrinsic::riscv_xcorevalu_alu_exths;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_exthz:
    ID = Intrinsic::riscv_xcorevalu_alu_exthz;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_extbs:
    ID = Intrinsic::riscv_xcorevalu_alu_extbs;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_extbz:
    ID = Intrinsic::riscv_xcorevalu_alu_extbz;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_slet:
    ID = Intrinsic::riscv_xcorevalu_alu_slet;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_sletu:
    ID = Intrinsic::riscv_xcorevalu_alu_sletu;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_min:
    ID = Intrinsic::riscv_xcorevalu_alu_min;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_minu:
    ID = Intrinsic::riscv_xcorevalu_alu_minu;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_max:
    ID = Intrinsic::riscv_xcorevalu_alu_max;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_maxu:
    ID = Intrinsic::riscv_xcorevalu_alu_maxu;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_clip:
    ID = Intrinsic::riscv_xcorevalu_alu_clip;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_clipu:
    ID = Intrinsic::riscv_xcorevalu_alu_clipu;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_addn:
    ID = Intrinsic::riscv_xcorevalu_alu_addn;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_addun:
    ID = Intrinsic::riscv_xcorevalu_alu_addun;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_addrn:
    ID = Intrinsic::riscv_xcorevalu_alu_addrn;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_addurn:
    ID = Intrinsic::riscv_xcorevalu_alu_addurn;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_subn:
    ID = Intrinsic::riscv_xcorevalu_alu_subn;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_subun:
    ID = Intrinsic::riscv_xcorevalu_alu_subun;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_subrn:
    ID = Intrinsic::riscv_xcorevalu_alu_subrn;
    break;
  case RISCV::BI__builtin_xcorevalu_alu_suburn:
    ID = Intrinsic::riscv_xcorevalu_alu_suburn;
    break;
case RISCV::BI__builtin_xcorevbitmanip_bitmanip_ff1:
    ID = Intrinsic::riscv_xcorevbitmanip_bitmanip_ff1;
    break;
  case RISCV::BI__builtin_xcorevbitmanip_bitmanip_fl1:
    ID = Intrinsic::riscv_xcorevbitmanip_bitmanip_fl1;
    break;
  case RISCV::BI__builtin_xcorevbitmanip_bitmanip_clb:
    ID = Intrinsic::riscv_xcorevbitmanip_bitmanip_clb;
    break;
  case RISCV::BI__builtin_xcorevbitmanip_bitmanip_cnt:
    ID = Intrinsic::riscv_xcorevbitmanip_bitmanip_cnt;
    break;
  case RISCV::BI__builtin_xcorevbitmanip_bitmanip_ror:
    ID = Intrinsic::riscv_xcorevbitmanip_bitmanip_ror;
    break;
  case RISCV::BI__builtin_xcorevbitmanip_bitmanip_extractr:
    ID = Intrinsic::riscv_xcorevbitmanip_bitmanip_extractr;
    break;
  case RISCV::BI__builtin_xcorevbitmanip_bitmanip_extractur:
