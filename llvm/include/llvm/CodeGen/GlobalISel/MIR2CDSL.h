//== llvm/CodeGen/GlobalISel/MIR2CDSL.h -----------------*- C++ -*-==//
//
...
class MIR2CDSL : public MachineFunctionPass {
public:
  static char ID;
  StringRef getPassName() const override { return "MIR2CDSL"; }
